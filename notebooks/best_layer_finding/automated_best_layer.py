...
res_df.to_csv(os.path.join(BASE_PATH, "notebooks", "best_layer_finding", MODEL_ID, "classification_data", "train_test_data.csv"), index=False)
...
for metric in [
    ...
    save_path = os.path.join(BASE_PATH, "notebooks", "best_layer_finding", MODEL_ID, "classification_data", "figures", f"train_test_different_datasets_direction_{metric}.html")
