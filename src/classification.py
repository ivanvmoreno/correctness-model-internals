...
class BinaryClassifier:
    def __init__(
        ...
        if not all(
            ...
            isinstance(test_label, bool) for test_label in test_labels
        ):
        ...
        self.test_false_positive_rate, self.test_true_positive_rate, _ = (
            roc_curve(self.test_labels, self.test_classification_score)
        )
        self.roc_auc = float(
    ...
    def optimal_train_set_cut(self):
        youden_index = (
            self.train_true_positive_rate - self.train_false_positive_rate
        )
